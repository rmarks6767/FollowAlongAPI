//TODO 1.3.5.b Add the references to the Account class and the ObjectGraphType.
using FollowAlongLearnAPI.Model.Base;
using GraphQL.Types;

namespace FollowAlongLearnAPI.Model.GraphTypes
{
    //TODO 1.3.5.a Add inheritance to the ObjectGraphType (translating to GraphQL) and have that have the type of Account.
    public class AccountGraph : ObjectGraphType<Account> 
    {
        //TODO 1.3.6.a Now create the constructor for the AccountGraph
        public AccountGraph()
        {
            //TODO 1.3.6.b Add a name and description to the AccountGraph.
            Name = "Account";
            ...
            //TODO 1.3.9.a Now create a GraphType for the Address model type.  Put it in the same GraphTypes folder.
            //TODO 1.3.9.d Now that we created that GraphType, we are going to register it like so:
            Field<AddressGraph>().Name("address"); //TODO 1.3.9.x / 1.3.8.x Here we are saying that this type has to be broken down more so go to that file to resolve the type that we pass it.
        }
    }
}

//TODO 1.4.0 Now we are ready to define the functionality of this new type.  We'll start with the Query portion of this Type, then we will move into the mutation section.  Head on over to the RootQuery class.