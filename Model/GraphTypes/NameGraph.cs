//TODO 3.8.b.2 Add references to the classes used with the inheritance.
using FollowAlongLearnAPI.Model.Base;
using GraphQL.Types;

namespace FollowAlongLearnAPI.Model.GraphTypes
{
    //TODO 3.8.b.1 This one will be set up very similarly to the NameGraph, add inheritance and map all of the fields.
